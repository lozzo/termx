...
#define TERMX_CLIENT_ABI_VERSION 3u
...
termx_status_v1 termx_engine_command(termx_handle_t engine_handle, const uint8_t *command_proto, size_t command_length, termx_handle_t *out_operation_handle);

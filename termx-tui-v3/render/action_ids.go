...
func ActionSpecCatalog() []ActionSpec {
	return []ActionSpec{
		...
		actionSpec(ActionFooterOpenPool, ActionDispatchApp, ActionSurfaceFooter, ActionSurfaceHelp).withFooter("t", "TERMINALS", StyleStatusAccent).withHelp("terminal manager"),
		...
		actionSpec(ActionPoolAttachTab, ActionDispatchApp, ActionSurfaceFooter, ActionSurfaceContent, ActionSurfaceInput, ActionSurfaceHelp).withFooter("tab", "", StyleStatusAccent).withHelp("attach as tab"),
		actionSpec(ActionPoolAttachFloat, ActionDispatchApp, ActionSurfaceFooter, ActionSurfaceContent, ActionSurfaceInput, ActionSurfaceHelp).withFooter("float", "", StyleStatusAccent).withHelp("attach as floating"),
		...
		actionSpec(ActionPoolDelete, ActionDispatchApp, ActionSurfaceFooter, ActionSurfaceContent, ActionSurfaceInput, ActionSurfaceHelp).withFooter("delete", "", StyleStatusWarning).withHelp("delete terminal inventory entry").withDanger(),

...
- Public host services are intentionally left running for inspection under `/tmp/termx-devstack`: web-control pid `3352733`, hub pid `3330463`, public daemon pid `3349076`.

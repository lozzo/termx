...
- 参考当前 [types.go](/home/lozzow/workdir/termx/tuiv2/workbench/types.go)
- 但迁到 root-level 公共包
...
- [mutate.go](/home/lozzow/workdir/termx/tuiv2/workbench/mutate.go)
...
在 [termx.go](/home/lozzow/workdir/termx/termx.go) 的 `Server` 中新增：

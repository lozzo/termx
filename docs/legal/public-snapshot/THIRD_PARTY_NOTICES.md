...
- Vendored source keeps upstream license files next to the corresponding material, including `vterm/internal/vt/LICENSE`; App font terms are distributed in `termx-app/public/third-party/FONTS.txt`.

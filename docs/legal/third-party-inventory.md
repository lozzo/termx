...
| private `termx-cloud` | `private/cloud/companion/cmd/termx-cloud` | 8 条外部 mapping；MIT、BSD-2-Clause、BSD-3-Clause | `private/cloud/companion/cmd/termx-cloud/THIRD_PARTY_NOTICES.txt` |

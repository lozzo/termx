...
tmp_dir="$(mktemp -d "${TMPDIR:-/tmp}/termx-android-notices.XXXXXX")"
...
) | sed -n 's/^TERMX_DEPENDENCY //p' | LC_ALL=C sort -u >"$tmp_dir/dependencies.txt"
...
{
  printf '%s\n\n' "TermX App Android Third-Party Notices"

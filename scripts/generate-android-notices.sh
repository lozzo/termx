...
tmp_dir="$(mktemp -d "${TMPDIR:-/tmp}/anytty-android-notices.XXXXXX")"
...
(
  ...
  ./gradlew -q \
    ...
    :app:anyttyResolvedRuntimeDependencies
) | sed -n 's/^ANYTTY_DEPENDENCY //p' | LC_ALL=C sort -u >"$tmp_dir/dependencies.txt"
...
{
  printf '%s\n\n' "AnyTTY App Android Third-Party Notices"

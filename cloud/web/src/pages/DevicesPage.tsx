...
export function DevicesPage() {
  ...
  return <>
    <PageHeader title="我的设备" meta="在需要远程访问的电脑上安装 AnyTTY daemon，设备上线后会自动显示当前连接区域" actions={<Button tone="primary" onClick={() => { setCommand(''); setDaemonName(''); setCopyState('idle'); setOpen(true) }}><Plus size={17} />添加设备</Button>} />

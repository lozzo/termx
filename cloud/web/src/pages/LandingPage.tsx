  ...
  return <div className="landing-page">
    ...
    <main>
      <section className="landing-hero">
        <div className="hero-copy"><span className="eyebrow">ANYTTY CLOUD</span><h1>AnyTTY Cloud</h1><strong className="hero-statement">随时回到你的电脑。</strong><p>Cloud 账号用于 daemon 注册、连接路由、Relay、订阅与管理。AnyTTY App 不需要账号；扫描目标服务生成的配对二维码后，端点只保存在当前设备。</p><div className="hero-actions"><Link className="button button-primary" to="/register">管理 Cloud 服务<ArrowRight size={18} /></Link><Link className="button" to="/login">登录 Cloud 控制台</Link></div><dl><div><dt>App 配对</dt><dd>目标服务二维码</dd></div><div><dt>连接方式</dt><dd>P2P / Relay</dd></div><div><dt>本地保存</dt><dd>无账号同步</dd></div></dl></div>
      ...
      <section className="final-cta"><div><img src={logo} alt="" /><h2>先注册 daemon，再让 App 扫描目标服务二维码。</h2><p>创建 Cloud 账号管理服务接入；AnyTTY App 本身无需登录。</p><Link className="button button-primary" to="/register">创建 Cloud 账号<ArrowRight size={18} /></Link></div></section>
    </main>

...
export function OverviewPage() {
  ...
  const metrics = [
    { label: '在线 Edge', value: `${value.edgeOnline}/${value.edgeTotal}`, icon: Server, to: '/edges' },
    { label: '在线 daemon', value: `${value.daemonOnline}/${value.daemonTotal}`, icon: Network, to: '/daemons' },
    { label: '实时连接', value: String(value.clientSessionOnline), icon: Cable, to: '/connections' },
    { label: '当期 Relay', value: bytes(value.relayBytesCurrentPeriod), icon: Activity, to: '/usage' },
  ]
  return <>

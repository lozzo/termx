...
func (runtime *Runtime) runControllerLink() {
	...
	for runtime.ctx.Err() == nil {
		...
		capabilities := []cloudv1.EdgeCapability{cloudv1.EdgeCapability_EDGE_CAPABILITY_CONTROL_STREAM, cloudv1.EdgeCapability_EDGE_CAPABILITY_DAEMON_LIFECYCLE_POLICY, cloudv1.EdgeCapability_EDGE_CAPABILITY_DAEMON_EDGE_RESELECTION, cloudv1.EdgeCapability_EDGE_CAPABILITY_IDENTITY_CERTIFICATE_ROTATION, cloudv1.EdgeCapability_EDGE_CAPABILITY_DAEMON_CONNECTION_ADMISSION}

...
func (*recordingRuntime) CancelRelayAllocationReservation(context.Context, string) error { return nil }
func (runtime *recordingRuntime) BeginRelayAllocationClose(_ context.Context, id string) error {
	runtime.mu.Lock()
	defer runtime.mu.Unlock()
	runtime.events = append(runtime.events, "begin:"+id)
	return nil
}
func (runtime *recordingRuntime) CloseRelayAllocation(_ context.Context, id string, ingress, egress uint64) error {
	runtime.mu.Lock()
	defer runtime.mu.Unlock()

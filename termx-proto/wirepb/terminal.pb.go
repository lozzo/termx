...
const file_wirepb_terminal_proto_rawDesc = "" +
	...
	"\awrapped\x18\x04 \x03(\bR\awrapped\"\xeb\x02\n" +
	"\bSnapshot\x12\x1f\n" +
	"\vterminal_id\x18\x01 \x01(\tR\n" +
	"terminalId\x12/\n" +
	...
	"\x13timestamp_unix_nano\x18\v \x01(\x03R\x11timestampUnixNano\"\xee\x01\n" +
...
var file_wirepb_terminal_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_wirepb_terminal_proto_goTypes = []any{
	...
	(*StorageEntry)(nil),             // 37: termx.protocol.wirepb.StorageEntry
	(*StorageGetParams)(nil),         // 38: termx.protocol.wirepb.StorageGetParams
	(*StoragePutParams)(nil),         // 39: termx.protocol.wirepb.StoragePutParams
	(*StorageDeleteParams)(nil),      // 40: termx.protocol.wirepb.StorageDeleteParams
	(*StorageDeleteResult)(nil),      // 41: termx.protocol.wirepb.StorageDeleteResult
	(*StorageListParams)(nil),        // 42: termx.protocol.wirepb.StorageListParams
	(*StorageListResult)(nil),        // 43: termx.protocol.wirepb.StorageListResult
	(*WorkbenchSnapshot)(nil),        // 44: termx.protocol.wirepb.WorkbenchSnapshot
	(*WorkbenchWorkspace)(nil),       // 45: termx.protocol.wirepb.WorkbenchWorkspace
	(*WorkbenchTab)(nil),             // 46: termx.protocol.wirepb.WorkbenchTab
	(*WorkbenchPane)(nil),            // 47: termx.protocol.wirepb.WorkbenchPane
	(*WorkbenchSplitNode)(nil),       // 48: termx.protocol.wirepb.WorkbenchSplitNode
	(*WorkbenchGetParams)(nil),       // 49: termx.protocol.wirepb.WorkbenchGetParams
	(*WorkbenchMutateParams)(nil),    // 50: termx.protocol.wirepb.WorkbenchMutateParams
	(*WorkbenchMutateResult)(nil),    // 51: termx.protocol.wirepb.WorkbenchMutateResult
	(*RemoteStatus)(nil),             // 52: termx.protocol.wirepb.RemoteStatus
	(*RemotePairStartParams)(nil),    // 53: termx.protocol.wirepb.RemotePairStartParams
	(*RemotePairStartResult)(nil),    // 54: termx.protocol.wirepb.RemotePairStartResult
	(*RemoteLocalEnableParams)(nil),  // 55: termx.protocol.wirepb.RemoteLocalEnableParams
	(*RemoteLocalStatus)(nil),        // 56: termx.protocol.wirepb.RemoteLocalStatus
	(*TerminalGridMetadata)(nil),     // 57: termx.protocol.wirepb.TerminalGridMetadata
	nil,                              // 58: termx.protocol.wirepb.TerminalInfo.TagsEntry
	nil,                              // 59: termx.protocol.wirepb.CreateParams.TagsEntry
	nil,                              // 60: termx.protocol.wirepb.SetTagsParams.TagsEntry
	nil,                              // 61: termx.protocol.wirepb.SetMetadataParams.TagsEntry
}
var file_wirepb_terminal_proto_depIdxs = []int32{
	...
	58, // 1: termx.protocol.wirepb.TerminalInfo.tags:type_name -> termx.protocol.wirepb.TerminalInfo.TagsEntry
	...
	59, // 4: termx.protocol.wirepb.CreateParams.tags:type_name -> termx.protocol.wirepb.CreateParams.TagsEntry
	...
	60, // 8: termx.protocol.wirepb.SetTagsParams.tags:type_name -> termx.protocol.wirepb.SetTagsParams.TagsEntry
	61, // 9: termx.protocol.wirepb.SetMetadataParams.tags:type_name -> termx.protocol.wirepb.SetMetadataParams.TagsEntry
	...
	35, // 28: termx.protocol.wirepb.Snapshot.screen:type_name -> termx.protocol.wirepb.RowSet
	...
	0,  // 31: termx.protocol.wirepb.StorageEntry.scope:type_name -> termx.protocol.wirepb.StorageScope
	0,  // 32: termx.protocol.wirepb.StorageGetParams.scope:type_name -> termx.protocol.wirepb.StorageScope
	0,  // 33: termx.protocol.wirepb.StoragePutParams.scope:type_name -> termx.protocol.wirepb.StorageScope
	0,  // 34: termx.protocol.wirepb.StorageDeleteParams.scope:type_name -> termx.protocol.wirepb.StorageScope
	0,  // 35: termx.protocol.wirepb.StorageDeleteResult.scope:type_name -> termx.protocol.wirepb.StorageScope
	0,  // 36: termx.protocol.wirepb.StorageListParams.scope:type_name -> termx.protocol.wirepb.StorageScope
	37, // 37: termx.protocol.wirepb.StorageListResult.entries:type_name -> termx.protocol.wirepb.StorageEntry
	45, // 38: termx.protocol.wirepb.WorkbenchSnapshot.workspaces:type_name -> termx.protocol.wirepb.WorkbenchWorkspace
	46, // 39: termx.protocol.wirepb.WorkbenchWorkspace.tabs:type_name -> termx.protocol.wirepb.WorkbenchTab
	47, // 40: termx.protocol.wirepb.WorkbenchTab.panes:type_name -> termx.protocol.wirepb.WorkbenchPane
	48, // 41: termx.protocol.wirepb.WorkbenchTab.root_split:type_name -> termx.protocol.wirepb.WorkbenchSplitNode
	48, // 42: termx.protocol.wirepb.WorkbenchSplitNode.children:type_name -> termx.protocol.wirepb.WorkbenchSplitNode
	44, // 43: termx.protocol.wirepb.WorkbenchMutateResult.snapshot:type_name -> termx.protocol.wirepb.WorkbenchSnapshot

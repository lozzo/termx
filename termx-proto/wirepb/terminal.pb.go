...
const file_wirepb_terminal_proto_rawDesc = "" +
	...
	"\x03env\x18\a \x03(\tR\x03env\x1a7\n" +
	"\tTagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\fworkbench_id\x18\b \x01(\tR\vworkbenchId\"1\n" +
	...
	"\townership\x18\x05 \x03(\tR\townership\"\xeb\x02\n" +
	"\bSnapshot\x12\x1f\n" +
	"\vterminal_id\x18\x01 \x01(\tR\n" +
	"terminalId\x12/\n" +
	...
	"\x13timestamp_unix_nano\x18\v \x01(\x03R\x11timestampUnixNano\"\xd1\t\n" +
...
var file_wirepb_terminal_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_wirepb_terminal_proto_goTypes = []any{
	...
	(*HistoryWindow)(nil),            // 38: termx.protocol.wirepb.HistoryWindow
	(*StorageEntry)(nil),             // 39: termx.protocol.wirepb.StorageEntry
	(*StorageGetParams)(nil),         // 40: termx.protocol.wirepb.StorageGetParams
	(*StoragePutParams)(nil),         // 41: termx.protocol.wirepb.StoragePutParams
	(*StorageDeleteParams)(nil),      // 42: termx.protocol.wirepb.StorageDeleteParams
	(*StorageDeleteResult)(nil),      // 43: termx.protocol.wirepb.StorageDeleteResult
	(*StorageListParams)(nil),        // 44: termx.protocol.wirepb.StorageListParams
	(*StorageListResult)(nil),        // 45: termx.protocol.wirepb.StorageListResult
	(*WorkbenchSnapshot)(nil),        // 46: termx.protocol.wirepb.WorkbenchSnapshot
	(*WorkbenchWorkspace)(nil),       // 47: termx.protocol.wirepb.WorkbenchWorkspace
	(*WorkbenchTab)(nil),             // 48: termx.protocol.wirepb.WorkbenchTab
	(*WorkbenchPane)(nil),            // 49: termx.protocol.wirepb.WorkbenchPane
	(*WorkbenchSplitNode)(nil),       // 50: termx.protocol.wirepb.WorkbenchSplitNode
	(*WorkbenchGetParams)(nil),       // 51: termx.protocol.wirepb.WorkbenchGetParams
	(*WorkbenchMutateParams)(nil),    // 52: termx.protocol.wirepb.WorkbenchMutateParams
	(*WorkbenchMutateResult)(nil),    // 53: termx.protocol.wirepb.WorkbenchMutateResult
	(*RemoteStatus)(nil),             // 54: termx.protocol.wirepb.RemoteStatus
	(*RemotePairStartParams)(nil),    // 55: termx.protocol.wirepb.RemotePairStartParams
	(*RemotePairStartResult)(nil),    // 56: termx.protocol.wirepb.RemotePairStartResult
	(*RemoteLocalEnableParams)(nil),  // 57: termx.protocol.wirepb.RemoteLocalEnableParams
	(*RemoteLocalStatus)(nil),        // 58: termx.protocol.wirepb.RemoteLocalStatus
	(*TerminalGridMetadata)(nil),     // 59: termx.protocol.wirepb.TerminalGridMetadata
	nil,                              // 60: termx.protocol.wirepb.TerminalInfo.TagsEntry
	nil,                              // 61: termx.protocol.wirepb.CreateParams.TagsEntry
	nil,                              // 62: termx.protocol.wirepb.SetTagsParams.TagsEntry
	nil,                              // 63: termx.protocol.wirepb.SetMetadataParams.TagsEntry
}
var file_wirepb_terminal_proto_depIdxs = []int32{
	...
	60, // 1: termx.protocol.wirepb.TerminalInfo.tags:type_name -> termx.protocol.wirepb.TerminalInfo.TagsEntry
	...
	61, // 4: termx.protocol.wirepb.CreateParams.tags:type_name -> termx.protocol.wirepb.CreateParams.TagsEntry
	...
	62, // 8: termx.protocol.wirepb.SetTagsParams.tags:type_name -> termx.protocol.wirepb.SetTagsParams.TagsEntry
	63, // 9: termx.protocol.wirepb.SetMetadataParams.tags:type_name -> termx.protocol.wirepb.SetMetadataParams.TagsEntry
	...
	36, // 28: termx.protocol.wirepb.Snapshot.screen:type_name -> termx.protocol.wirepb.RowSet
	...
	7,  // 31: termx.protocol.wirepb.HistoryWindow.size:type_name -> termx.protocol.wirepb.Size
	36, // 32: termx.protocol.wirepb.HistoryWindow.rows:type_name -> termx.protocol.wirepb.RowSet
	...
	39, // 39: termx.protocol.wirepb.StorageListResult.entries:type_name -> termx.protocol.wirepb.StorageEntry
	47, // 40: termx.protocol.wirepb.WorkbenchSnapshot.workspaces:type_name -> termx.protocol.wirepb.WorkbenchWorkspace
	48, // 41: termx.protocol.wirepb.WorkbenchWorkspace.tabs:type_name -> termx.protocol.wirepb.WorkbenchTab
	49, // 42: termx.protocol.wirepb.WorkbenchTab.panes:type_name -> termx.protocol.wirepb.WorkbenchPane
	50, // 43: termx.protocol.wirepb.WorkbenchTab.root_split:type_name -> termx.protocol.wirepb.WorkbenchSplitNode
	50, // 44: termx.protocol.wirepb.WorkbenchSplitNode.children:type_name -> termx.protocol.wirepb.WorkbenchSplitNode
	46, // 45: termx.protocol.wirepb.WorkbenchMutateResult.snapshot:type_name -> termx.protocol.wirepb.WorkbenchSnapshot

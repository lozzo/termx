...
func DefaultBindingCatalog() []BindingDoc {
	return []BindingDoc{
		...
		{ID: "root-display", ConfigKey: "root.display", Mode: ModeNormal, Group: "Most Used", Binding: Binding{Type: tea.KeyCtrlV, Action: ActionEnterDisplayMode}, KeyLabel: "Ctrl-V", HelpText: "display mode — scrollback and zoom", StatusText: "V DISPLAY"},
		...
		{ID: "display-enter", ConfigKey: "display.enter", Mode: ModeDisplay, Group: "Resize & Display", Binding: Binding{Type: tea.KeyCtrlV, Action: ActionEnterDisplayMode}, KeyLabel: "Ctrl-V", HelpText: "enter display mode"},
		{ID: "display-scroll-up", ConfigKey: "display.scroll_up", Mode: ModeDisplay, Group: "Resize & Display", Binding: Binding{Type: tea.KeyRunes, Rune: 'u', Action: ActionScrollUp}, KeyLabel: "u/d", HelpText: "scroll up/down", StatusText: "u/d SCROLL"},
		{ID: "display-scroll-down", ConfigKey: "display.scroll_down", Mode: ModeDisplay, Binding: Binding{Type: tea.KeyRunes, Rune: 'd', Action: ActionScrollDown}},

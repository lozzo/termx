...
var defaultBindingCatalog = []BindingDoc{
	...
	{ID: "root-resize", ConfigKey: "root.resize", Mode: ModeNormal, Group: "Most Used", Binding: Binding{Type: tea.KeyCtrlR, Action: ActionEnterResizeMode}, KeyLabel: "Ctrl-R", HelpText: "resize mode — resize panes, layout, content position", StatusText: "R RESIZE"},
	...
	{ID: "resize-content-left", ConfigKey: "resize.content.left", Mode: ModeResize, Group: "Resize & Display", Binding: Binding{Type: tea.KeyRunes, Rune: 'A', Action: ActionMovePaneContentLeft}, KeyLabel: "Shift-W/A/S/D or Shift-arrows", HelpText: "pan terminal content inside pane", StatusText: "Shift+WASD PAN"},
	{ID: "resize-content-right", ConfigKey: "resize.content.right", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: 'D', Action: ActionMovePaneContentRight}},
	{ID: "resize-content-up", ConfigKey: "resize.content.up", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: 'W', Action: ActionMovePaneContentUp}},
	{ID: "resize-content-down", ConfigKey: "resize.content.down", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: 'S', Action: ActionMovePaneContentDown}},
	{ID: "resize-content-arrow-left", ConfigKey: "resize.content.arrow_left", Mode: ModeResize, Binding: Binding{Type: tea.KeyShiftLeft, Action: ActionMovePaneContentLeft}},
	{ID: "resize-content-arrow-right", ConfigKey: "resize.content.arrow_right", Mode: ModeResize, Binding: Binding{Type: tea.KeyShiftRight, Action: ActionMovePaneContentRight}},
	{ID: "resize-content-arrow-up", ConfigKey: "resize.content.arrow_up", Mode: ModeResize, Binding: Binding{Type: tea.KeyShiftUp, Action: ActionMovePaneContentUp}},
	{ID: "resize-content-arrow-down", ConfigKey: "resize.content.arrow_down", Mode: ModeResize, Binding: Binding{Type: tea.KeyShiftDown, Action: ActionMovePaneContentDown}},
	{ID: "resize-content-align-left", ConfigKey: "resize.content.align_left", Mode: ModeResize, Group: "Resize & Display", Binding: Binding{Type: tea.KeyRunes, Rune: '0', Action: ActionAlignPaneContentLeft}, KeyLabel: "0/$ ^/B", HelpText: "align terminal content to pane edges", StatusText: "0/$ ^/B ALIGN"},
	{ID: "resize-content-align-right", ConfigKey: "resize.content.align_right", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: '$', Action: ActionAlignPaneContentRight}},
	{ID: "resize-content-align-top", ConfigKey: "resize.content.align_top", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: '^', Action: ActionAlignPaneContentTop}},
	{ID: "resize-content-align-bottom", ConfigKey: "resize.content.align_bottom", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: 'B', Action: ActionAlignPaneContentBottom}},
	{ID: "resize-content-center", ConfigKey: "resize.content.center", Mode: ModeResize, Group: "Resize & Display", Binding: Binding{Type: tea.KeyRunes, Rune: 'm', Action: ActionCenterPaneContent}, KeyLabel: "m", HelpText: "center terminal content in pane", StatusText: "m CENTER"},
	{ID: "resize-content-center-horizontal", ConfigKey: "resize.content.center_horizontal", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: '|', Action: ActionCenterPaneContentHorizontal}},
	{ID: "resize-content-center-vertical", ConfigKey: "resize.content.center_vertical", Mode: ModeResize, Binding: Binding{Type: tea.KeyRunes, Rune: '_', Action: ActionCenterPaneContentVertical}},
	{ID: "resize-content-reset", ConfigKey: "resize.content.reset", Mode: ModeResize, Group: "Resize & Display", Binding: Binding{Type: tea.KeyRunes, Rune: 'r', Action: ActionResetPaneContentOffset}, KeyLabel: "r", HelpText: "reset terminal content placement", StatusText: "r RESET"},
	...
	{ID: "display-enter", ConfigKey: "display.enter", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyCtrlV, Action: ActionEnterDisplayMode}, KeyLabel: "Ctrl-V", HelpText: "enter copy mode"},
	{ID: "display-up", ConfigKey: "display.up", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyUp, Action: ActionCopyModeCursorUp}, KeyLabel: "arrows or h/j/k/l", HelpText: "move copy cursor", StatusText: "MOVE CURSOR"},
	...
	{ID: "display-left-alt", ConfigKey: "display.left_alt", Mode: ModeDisplay, Binding: Binding{Type: tea.KeyRunes, Rune: 'h', Action: ActionCopyModeCursorLeft}},
	...
	{ID: "display-page-up", ConfigKey: "display.page_up", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyPgUp, Action: ActionCopyModePageUp}, KeyLabel: "PgUp/PgDn", HelpText: "page up/down", StatusText: "PG SCROLL"},
	...
	{ID: "display-half-up", ConfigKey: "display.half_up", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyRunes, Rune: 'u', Action: ActionCopyModeHalfPageUp}, KeyLabel: "u/d", HelpText: "half-page up/down", StatusText: "u/d HALF"},
	...
	{ID: "display-line-start", ConfigKey: "display.line_start", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyHome, Action: ActionCopyModeStartOfLine}, KeyLabel: "Home/End", HelpText: "line start/end", StatusText: "HOME/END LINE"},
	...
	{ID: "display-top", ConfigKey: "display.top", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyRunes, Rune: 'g', Action: ActionCopyModeTop}, KeyLabel: "g/G", HelpText: "top/bottom", StatusText: "g/G EDGE"},
	...
	{ID: "display-select", ConfigKey: "display.select", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeySpace, Action: ActionCopyModeBeginSelection}, KeyLabel: "Space", HelpText: "mark or copy selection", StatusText: "Space MARK/COPY"},
	{ID: "display-copy", ConfigKey: "display.copy", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyRunes, Rune: 'y', Action: ActionCopyModeCopySelection}, KeyLabel: "y or Enter", HelpText: "copy selection", StatusText: "y COPY"},
	...
	{ID: "display-paste-buffer", ConfigKey: "display.paste_buffer", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyRunes, Rune: 'p', Action: ActionPasteBuffer}, KeyLabel: "p/P", HelpText: "paste last copy or system clipboard", StatusText: "p/P PASTE"},
	...
	{ID: "display-history", ConfigKey: "display.history", Mode: ModeDisplay, Group: "Copy Mode", Binding: Binding{Type: tea.KeyRunes, Rune: 'H', Action: ActionOpenClipboardHistory}, KeyLabel: "H", HelpText: "open clipboard history", StatusText: "H HISTORY"},

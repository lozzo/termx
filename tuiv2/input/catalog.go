...
func DefaultBindingCatalog() []BindingDoc {
	return []BindingDoc{
		...
		{ID: "display-select", ConfigKey: "display.select", Mode: ModeDisplay, Group: "Resize & Display", Binding: Binding{Type: tea.KeySpace, Action: ActionCopyModeBeginSelection}, KeyLabel: "Space", HelpText: "mark selection start", StatusText: "Space MARK"},

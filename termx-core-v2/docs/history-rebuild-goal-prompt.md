...
- `termx-tui-v3/docs/architecture.md`，仅在 R310 或 tui-v3 联动时读取相关部分
...
- 在 `termx-core-v2/history` 内写 fake semantic transaction / fake classifier / fake projector harness。

...
const (
	...
	EventBeginSynchronizedFrame   EventKind = "begin-synchronized-frame"
	EventEndSynchronizedFrame     EventKind = "end-synchronized-frame"
	EventReplacePrimaryFrame      EventKind = "replace-primary-frame"

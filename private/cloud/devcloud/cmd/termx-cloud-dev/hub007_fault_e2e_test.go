...
func operatorPost(t *testing.T, client *http.Client, origin, path string, requestBody, responseBody proto.Message) {
	...
	for _, cookie := range client.Jar.Cookies(request.URL) {
		if cookie.Name == "termx_cloud_operator_csrf" {

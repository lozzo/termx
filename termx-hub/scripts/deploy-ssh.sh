...
CONTROL_URL="${TERMX_HUB_CONTROL_URL:-http://127.0.0.1:12306}"
CONTROL_SECRET="${TERMX_HUB_CONTROL_SECRET:-termx-development-hub-secret-change-me}"
...
TERMX_HUB_CONTROL_URL=${CONTROL_URL}
TERMX_HUB_CONTROL_SECRET=${CONTROL_SECRET}

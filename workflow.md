...
- 当前最早未完成切片是 `AR004B`。在 `AR001-AR005` 全部完成前，暂停 `C3B` 以及后续连接功能开发。
...
| AR004B | 进行中 | CLI application contract | 在 `client/runtime` 按 endpoint/terminal/file/workspace/access 定义调用方需要的窄 interface/DTO；先补 harness，不接 concrete client |

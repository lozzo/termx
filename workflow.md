...
- 当前下一步是切片 57：默认入口 styled UI + pane command smoke 与视觉验收，覆盖 styled frame、连续 pane border、split/close/resize/zoom 后行宽恒等、content rect terminal resize 和 copy rebind。

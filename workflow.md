...
- 当前下一步是切片 53：pane 结构命令 contract，先把 split、close、close and kill、focus、zoom、resize、set size、balance、panel presentation 做成统一 semantic command；快捷键、鼠标、测试入口和后续 CLI mini command 均只能作为 adapter。

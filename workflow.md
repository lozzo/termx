...
- 已收紧 core persisted logical line record metadata 恢复校验：persisted record 必须是 clean、known origin、persisted residency、连续覆盖当前 index 且 generation 匹配；dirty 或未知 origin 的 sidecar 会被视为损坏并回退。

...
- 当前下一步是切片 48：建立 cell matrix compositor 与 ANSI serializer，支持 styled glyph、wide cell footprint、owner/layer、continuation/safe flag、右边框不丢和无默认 ASCII chrome。

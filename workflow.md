...
- 当前下一步是切片 52：toast / overlay styled chrome，把 toast 与 Terminal Picker overlay 升级为 styled chrome，覆盖 border/background/severity/pending/close action region/opaque cursor 和窄屏退化。

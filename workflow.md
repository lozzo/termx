...
- 当前正在进行切片 215C：215B 已把 size lock、content pan、align、center/reset 和 layout toggle 收口到 `TerminalViewBinding.Layout`，下一步收敛 overlay keyboard command router，再按 215D-215E 逐项补齐未实现能力。

...
- 当前正在进行切片 215：先按 `termx-tui-v3/docs/keybindings.md` 的 `tuiv2` 迁移基准收敛快捷键、footer/help 可见声明和对应 harness，再继续 shared terminal/view role 信息展示。

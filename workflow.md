...
| 14. core-v2 protocol service 与 HistoryWindow 实服务 | 进行中 | `termx-core-v2/`、`internal/protocol/`、`termx-proto/` | create/get/list/set metadata/restart/remove/events/input/resize/history.window 由 core-v2 服务；HistoryWindow 来自 logical line truth；协议测试通过 |
...
当前下一步：继续切片 14“core-v2 protocol service 与 HistoryWindow 实服务”。

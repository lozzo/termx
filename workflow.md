...
- 当前最早未完成切片是 `AR004B2`。在 `AR001-AR005` 全部完成前，暂停 `C3B` 以及后续连接功能开发。
...
| AR004B2 | 进行中 | Terminal application contract | 按 lifecycle/attach/input/resize/history/live/event 分组定义 CLI/TUI 共用 contract；不复制 wire union 或 concrete client |

...
- 当前快捷键迁移已完成到 215C：overlay keyboard command router 已收敛到 `ActionSpec`、`ShellContentActionMsg` 和 reducer/effect/message；下一步执行 215D，再按 215E 补齐剩余未实现能力。

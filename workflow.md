...
- 当前快捷键迁移已完成到 215C2：pane mode `s LOCK` 已复用 view-local terminal layout command；下一步按 215D、215D1、215F 连续收敛非 history 快捷键。215E clipboard paste/history overlay 已阻塞后置，history MVP 今天不重启。

...
- 当前下一步是切片 55：pane resize / size change geometry，实现按方向/步长 resize、按比例或固定 cell size set size、balance/equalize，并让 layout measurement、active terminal content rect resize 去重和 copy mode authoritative window rebind 跟随几何变化。

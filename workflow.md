...
- `215E1-R157 floating overlay repaint isolation` 已完成：copy/history 增量 patch 遇到 floating 覆盖会退回整帧；floating 的矩形和内容空白都由 overlay 背景接管，避免底层 pane 的 history 样式污染浮窗。

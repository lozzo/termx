...
## 6. resize / connection / display 规则

### 6.1 display 属性

pane 当前有两类容易混淆但必须分开的属性：
...
- `fit / fixed` 只决定 pane 自己怎么显示
- `owner / follower` 只决定谁能提交 PTY size
...
- pane/terminal 名称
- `live / saved / exit / owner / follower / fit / fixed / share` 等关系状态

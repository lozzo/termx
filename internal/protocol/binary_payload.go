...
func historyWindowToWirePB(window *HistoryWindow) *wirepb.HistoryWindow {
	...
	setIntSliceUnknownField(msg, historyWindowResponseRowScreenRowsFieldNumber, window.RowScreenRows)
	setBoolSliceUnknownField(msg, historyWindowResponseRowScreenRowSetFieldNumber, window.RowScreenRowSet)
...
func historyWindowFromWirePB(msg *wirepb.HistoryWindow) (*HistoryWindow, error) {
	...
	return &HistoryWindow{
		...
		RowScreenRows:   intSliceUnknownField(msg, historyWindowResponseRowScreenRowsFieldNumber),
		RowScreenRowSet: boolSliceUnknownField(msg, historyWindowResponseRowScreenRowSetFieldNumber),
		Lines:           lines,

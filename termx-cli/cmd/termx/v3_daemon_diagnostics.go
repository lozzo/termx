...
const daemonMemstatsDirEnv = "TERMX_DAEMON_MEMSTATS_DIR"
const daemonMemstatsStageEnv = "TERMX_DIAG_STAGE"
const daemonMemstatsStageFileEnv = "TERMX_DIAG_STAGE_FILE"

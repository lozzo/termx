...
import (
	...
	clientruntimeadapter "github.com/muxvia/muxvia/tui/adapter/clientruntime"
	tuiprotocol "github.com/muxvia/muxvia/tui/adapter/protocol"
	systemadapter "github.com/muxvia/muxvia/tui/adapter/system"
	"github.com/muxvia/muxvia/tui/app"
	tuiport "github.com/muxvia/muxvia/tui/port"
...
func runAttachCommandWithClientRuntime(cmd *cobra.Command, endpointID, terminalID, socket, logFile, configPath string) error {
	if !isInteractiveTerminal() {
		return usageCLIError("muxvia terminal attach requires an interactive terminal")
	}

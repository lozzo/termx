...
func newRootCmd() *cobra.Command {
	...
	cmd.PersistentFlags().StringVar(&logFile, "log-file", "", "log file path (default: $MUXVIA_LOG_FILE or XDG state dir)")
	cmd.PersistentFlags().StringVar(&configPath, "config", "", "muxvia config path (default: XDG config dir tui-v3.yaml)")

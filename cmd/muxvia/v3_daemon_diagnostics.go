...
const daemonHeapProfileDirEnv = "MUXVIA_DAEMON_HEAP_PROFILE_DIR"
const daemonMemstatsDirEnv = "MUXVIA_DAEMON_MEMSTATS_DIR"
const daemonMemstatsStageEnv = "MUXVIA_DIAG_STAGE"
const daemonMemstatsStageFileEnv = "MUXVIA_DIAG_STAGE_FILE"

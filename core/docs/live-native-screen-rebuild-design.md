...
- `core/live.SurfaceTrack`：core 当前 native screen 的 owner，仍是 vterm screen state 的承载点。
...
文件：`tui/state/live.go`、`tui/app/live.go`、`tui/app/runtime.go`

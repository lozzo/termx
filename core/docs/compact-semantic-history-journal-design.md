...
PTY bytes / resize
  -> single SemanticTap
       owns one vterm parser/emulator, cursor, modes, alt state and terminal response
...
- history semantic consumer 是 history journal owner，必须使用 vterm semantic pass 解释

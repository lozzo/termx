...
func (connection *serverConnection) dispatch(ctx context.Context, request *cloudpb.IPCRequest) (*cloudpb.IPCResponse, io.Closer, error) {
	...
	case *cloudpb.IPCRequest_ListManagedDevices:
		response, err := connection.client.ListManagedDevices(ctx, operation.ListManagedDevices)
		return &cloudpb.IPCResponse{Result: &cloudpb.IPCResponse_ManagedDevices{ManagedDevices: response}}, nil, err
	...
	case *cloudpb.IPCRequest_ReportDaemonCommandResult:
		response, err := connection.client.ReportDaemonCommandResult(ctx, operation.ReportDaemonCommandResult)
		return &cloudpb.IPCResponse{Result: &cloudpb.IPCResponse_ReportDaemonCommandResult{ReportDaemonCommandResult: response}}, nil, err

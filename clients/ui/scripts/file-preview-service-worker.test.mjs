...
describe('anytty file preview service worker', () => {
...
function createPreviewWorkerRuntime() {
  ...
  const context = createContext({
    ...
    clearTimeout,
    self: {
      location: { origin: 'https://anytty.test' },
      skipWaiting() {},
      clients: {
  ...
  new Script(readFileSync(resolve('public/anytty-file-preview-sw.js'), 'utf8')).runInContext(context)
  ...
  return {
    ...
    async fetchRange(range, onRequest) {
      ...
      fetchListener({
        ...
        request: {
          method: 'GET',
          url: 'https://anytty.test/__anytty_file_preview__/preview-test?size=104857600&mime=video%2Fmp4',

...
import type { LocalStatus, RtcSession } from '../core/transport'
...
describe('MachineWorkspace real file manager flow', () => {
  afterEach(() => {
    cleanup()
  })
  ...
  it('preserves file navigation across list and terminal pages for the same terminal, then resets for a new terminal context', async () => {
    ...
    const sessions: Array<ReturnType<typeof createMockMachineWorkspaceSession>> = []

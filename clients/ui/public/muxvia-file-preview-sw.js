...
self.addEventListener('message', (event) => {
  ...
  if (data.type === 'muxvia-preview-response') {
  ...
  if (data.type === 'muxvia-preview-error') {
    const pending = pendingRequests.get(data.requestId)
    if (!pending) return
    pendingRequests.delete(data.requestId)
  ...
  if (data.type === 'muxvia-preview-configure' && typeof data.token === 'string') {
  ...
  if (data.type === 'muxvia-preview-release' && typeof data.token === 'string') {

...
self.addEventListener('message', (event) => {
  ...
  if (data.type === 'anytty-preview-response') {
  ...
  if (data.type === 'anytty-preview-error') {
    const pending = pendingRequests.get(data.requestId)
    if (!pending) return
    pendingRequests.delete(data.requestId)
  ...
  if (data.type === 'anytty-preview-configure' && typeof data.token === 'string') {
  ...
  if (data.type === 'anytty-preview-release' && typeof data.token === 'string') {

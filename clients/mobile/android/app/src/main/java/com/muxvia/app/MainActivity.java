...
public class MainActivity extends BridgeActivity {
    private static final String TAG = "MuxviaMainActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        MuxviaDebugLog.init(this);
        ...
        if (webView != null) {
            webView.setWebChromeClient(new MuxviaWebChromeClient(getBridge()));
        ...
        MuxviaDebugLog.i(TAG, "MainActivity created debug=" + isDebug);
    }
}
